...
# Read in Rasters
mask, geom, proj = readRaster(r'e:\data\droughtindices\masks\nad83\mask4.tif',1,-9999)
usdms = readRasters('e:\\data\\droughtindices\\usdm\\usdmrasters\\nad83\\all\\', -9999)[0]
usdm = readRaster('e:\\data\\droughtindices\\usdm\\usdmall\\test.tif',1, -9999)[0]
...
usdmonths = [a for a in usdmonths if a[0][0][-2:] != '12'] # The 12s fall into the second half of the 11th interval, the rma does have a 12 - 1 interval
...
toRasters(usdmonths2,'e:\\data\\droughtindices\\usdm\\usdmrasters\\nad83\\usdmodes\\',geom,proj)
